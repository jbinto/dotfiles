...
# 2014-04-03: add /usr/local/bin before others, make `brew doctor` happy
export PATH="/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/sbin:/opt/X11/bin:/Users/jbinto/bin"
